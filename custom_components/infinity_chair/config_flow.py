"""Config flow for the Infinity chair (Bluetooth discovery via proxies)."""
...
from .const import BLE_NAME_PREFIX, DOMAIN


class InfinityChairConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for the Infinity chair."""
    ...
    async def async_step_bluetooth(
        ...
        """Handle a chair discovered over Bluetooth."""
    ...
    async def async_step_bluetooth_confirm(
        ...
        """Confirm adding a discovered chair."""
    ...
    async def async_step_user(
        ...
        """Handle manual setup: pick from chairs the proxies can see."""
        if user_input is not None:
